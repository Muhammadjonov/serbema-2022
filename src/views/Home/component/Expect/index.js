...
function Expect() {
  ...
  //     icon: images.List,
  //     title: "Publication",
  //     text: "All accepted and presented papers of the SEBREMA-2022 will be submitted for publication in open access conference proceedings and peer-reviewed journals indexed in SCOPUS and/or Web of Science.",
  //   },
              ...
              <div className="expect-card">
                ...
                <div className="text-content">
                  <div className="title">{t("siteVisits")}</div>
                  {
                    lang === "en" ? (
                      <div className="description">
                        For the first time in Central Asia? SEBREMA 2022 is pleased to invite you <br />
                      ...
                      <div className="description">
                        Впервые в Средней Азии? SEBREMA 2022 рада пригласить вас <br />
                      ...
                      <div className="description">
                        Markaziy Osiyoga birinchi bor tashrifingizmi? SEBREMA 2022 sizni mamnuniyat bilan taklif qiladi <br />
