      ...
      {/* <Col xs={{ span: 24 }} md={{ span: 12 }} lg={{ span: 8 }}>
        <div className="card-box conference_fee">
          <div className="stay-card">
            ...
            </div>
            {
              showMore3 ? (
                <div className="description">
                  ...
                  <ul>
                    <li>
                      - Professional translation from Uzbek/Russan language into English
                    </li>
                    <li>
                      -Layout correction according to the template of the publisher
                    </li>
                    <li>
                      - Proofreading of the research paper
                    </li>
                  </ul>
            ...
            <div className="read-more" onClick={() => toggleShowMore(setShowMore3)}>{showMore3 ? t("hide") : t("showMore")}</div>
          </div>
        </div>
      </Col> */}
      <Col xs={{ span: 24 }} md={{ span: 12 }} lg={{ span: 8 }}>
